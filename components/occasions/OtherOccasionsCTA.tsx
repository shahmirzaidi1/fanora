// components/occasions/OtherOccasionsCTA.tsx
import React from 'react';
import Link from 'next/link';
import ScrollAnimated from '@/components/landing/ScrollAnimated'; // Reusable
import { OccasionsPageCTAData } from '@/types/occasionsPageData';

interface OtherOccasionsCTAProps {
  data: OccasionsPageCTAData;
}

const OtherOccasionsCTA: React.FC<OtherOccasionsCTAProps> = ({ data }) => {
  return (
...
export default OtherOccasionsCTA;