// components/experiences/ExperiencesPageHero.tsx
import React from 'react';
import ScrollAnimated from '@/components/landing/ScrollAnimated'; // Reusable
import { ExperiencesPageHeroData } from '@/types/experiencesPageData';

interface ExperiencesPageHeroProps {
  data: ExperiencesPageHeroData;
}

const ExperiencesPageHero: React.FC<ExperiencesPageHeroProps> = ({ data }) => {
  const heroBgStyle = {
...
export default ExperiencesPageHero;