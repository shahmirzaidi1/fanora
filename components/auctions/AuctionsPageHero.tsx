// components/auctions/AuctionsPageHero.tsx
import React from 'react';
import ScrollAnimated from '@/components/landing/ScrollAnimated'; // Reusable
import { AuctionsPageHeroData } from '@/types/auctionsPageData';

interface AuctionsPageHeroProps {
  data: AuctionsPageHeroData;
}

const AuctionsPageHero: React.FC<AuctionsPageHeroProps> = ({ data }) => {
  const heroBgStyle = {
...
export default AuctionsPageHero;